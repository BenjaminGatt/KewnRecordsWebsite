...
<html>
  ...
  <body onload="startTimer()">
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v10.0" nonce="kq82WSm4"></script>
    <header class="no-select" id="top">
      <nav>
        <div class="row">
          <a href="index.php"
            ><img
          ...
          <a class="mobile-nav-icon">
            <svg viewBox="0 0 100 80" width="40" height="40">
              <rect width="100" height="12" fill="#fff"></rect>
              <rect y="30" width="100" height="12" fill="#fff"></rect>
              <rect y="60" width="100" height="12" fill="#fff"></rect>
            </svg>
          </a>
        </div>
      </nav>
      <div class="hero-logo">
        <img
          src="resources/img/KEWNrecords_logo+words white.png"
          alt="KEWN Records logo"
        />
      </div>
      <div class="hero-text-box">
        <h1>
        Established in late 2017 kewn records is an independent record label and artist collective based in Malta, working exclusively to release Maltese music internationally.
        </h1>
        <a class="btn btn-full about-btn" href="about.html">About Us</a>
      </div>
    </header>
    <div class="banner">
      <img id="banner-img" src="resources/img/banner/NIKET-Banner Announcement-min.jpg" />
      <button type="button" onclick="displayPreviousImage()" class="previous-btn"><</button>
      <button type="button" onclick="displayNextImage()" class="next-btn">></button>
    </div>

    <section class="updates">
      <div class="row updates-header">
        <h2>Updates</h2>
      </div>
      <div class="row">
        <div class="col span-1-of-2">
          <div class="fb-post top-frame" data-href="https://www.facebook.com/kewnrecords/posts/2440774059521290" data-width="400" data-show-text="true"><blockquote cite="https://www.facebook.com/kewnrecords/posts/2440774059521290" class="fb-xfbml-parse-ignore"><p>BILA Deheb, Incens u... Album out now! Physical copies of the EP on CD and Cassette available, as well as streaming on popular music streaming sites! 

            http://smarturl.it/DehebIncensUBila</p>Posted by <a href="https://www.facebook.com/kewnrecords/">Kewn Records</a> on&nbsp;<a href="https://www.facebook.com/kewnrecords/posts/2440774059521290">Saturday, 4 January 2020</a></blockquote></div>
            <div class="fb-post" data-href="https://www.facebook.com/kewnrecords/posts/2316800098585354" data-width="400" data-show-text="true"><blockquote cite="https://www.facebook.com/kewnrecords/posts/2316800098585354" class="fb-xfbml-parse-ignore"><p>BILA at The Farsons Beer Festival 

              📸: Joseph Camilleri</p>Posted by <a href="https://www.facebook.com/kewnrecords/">Kewn Records</a> on&nbsp;<a href="https://www.facebook.com/kewnrecords/posts/2316800098585354">Wednesday, 7 August 2019</a></blockquote></div>
        </div>
        <div class="col span-1-of-2">
          <div class="fb-post top-frame" data-href="https://www.facebook.com/kewnrecords/posts/2255759074689457" data-width="400" data-show-text="true"><blockquote cite="https://www.facebook.com/kewnrecords/posts/2255759074689457" class="fb-xfbml-parse-ignore"><p>Have you seen 400ppm &#039;s music video for &#039;David Buckel&#039; ? It&#039;s available on 7&quot; vinyl!</p>Posted by <a href="https://www.facebook.com/kewnrecords/">Kewn Records</a> on&nbsp;<a href="https://www.facebook.com/kewnrecords/posts/2255759074689457">Monday, 6 May 2019</a></blockquote></div>
          <h3 class="index-updates">
            <a href="updates.html">
              Click here for<br />
              more updates</a
            >
      ...
      <div class="row">
          <form method="post" action="resources/php/mailer-new.php" class="contact-form">
              ...
              <div class="row">
                  ...
                  <div class="col span-2-of-3" id="form">
